...
BEHAVIOR_STRATEGY = (
    ...
    "- reminder: time-based reminders. Use relative time for offsets: "
    "+5m, +1h, +2h30m, +1d. Use ISO 8601 for specific times: 2026-03-11T15:00:00. "
    "Do NOT calculate time yourself — the tool handles it.\n"
